...
import controller.modifier_transfer_card_directly.insert_transaction_controller;
import modul.danhmucchi;
import view.view_ver2;
import javax.swing.ImageIcon;
import javax.swing.JButton;

public class card extends KGradientPanel{
    ...
    public card (view_ver2 c) {
		...
		JLabel lblNewLabel_5 = new JLabel("Email receiver/Code");
		...
		gl_gradientPanel_3_1.setHorizontalGroup(
			gl_gradientPanel_3_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_gradientPanel_3_1.createSequentialGroup()
					.addContainerGap()
					.addComponent(spending_goals, GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_gradientPanel_3_1.setVerticalGroup(
			gl_gradientPanel_3_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_gradientPanel_3_1.createSequentialGroup()
					.addContainerGap()
					.addComponent(spending_goals, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
		...
		btnAccept.kHoverEndColor = new Color(168, 237, 234);
		...
		btnNewButton.setIcon(new ImageIcon(card.class.getResource("/view/resource/left.png")));
					...
					.addGroup(gl_gradientPanel_2.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_gradientPanel_2.createSequentialGroup()
							.addGroup(gl_gradientPanel_2.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(lblNewLabel_5_1_1_1, GroupLayout.PREFERRED_SIZE, 192, GroupLayout.PREFERRED_SIZE))
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_gradientPanel_2.createParallelGroup(Alignment.LEADING)
								.addComponent(gradientPanel_3_1_1_1, GroupLayout.DEFAULT_SIZE, 447, Short.MAX_VALUE)
								.addComponent(gradientPanel_3_1_1_1_1, GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE)
								.addComponent(gradientPanel_3_1_1_1_1_1, GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE)))
						.addGroup(gl_gradientPanel_2.createSequentialGroup()
							.addComponent(lblNewLabel_5_1, GroupLayout.PREFERRED_SIZE, 218, GroupLayout.PREFERRED_SIZE)
							.addGap(4)
							.addComponent(gradientPanel_3_1, GroupLayout.DEFAULT_SIZE, 447, Short.MAX_VALUE))
						.addGroup(gl_gradientPanel_2.createSequentialGroup()
							.addComponent(lblNewLabel_5, GroupLayout.PREFERRED_SIZE, 218, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(gradientPanel_3, GroupLayout.DEFAULT_SIZE, 447, Short.MAX_VALUE))
						.addGroup(gl_gradientPanel_2.createSequentialGroup()
							.addComponent(lblNewLabel_5_1_1, GroupLayout.PREFERRED_SIZE, 218, GroupLayout.PREFERRED_SIZE)
							.addGap(4)
							.addComponent(gradientPanel_3_1_1, GroupLayout.DEFAULT_SIZE, 447, Short.MAX_VALUE)))
					.addGap(68))
		);
					...
					.addGroup(gl_gradientPanel_2.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_gradientPanel_2.createSequentialGroup()
							.addGroup(gl_gradientPanel_2.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(gradientPanel_3, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 54, GroupLayout.PREFERRED_SIZE))
							.addGap(26)
							...
							.addGap(25)
							.addGroup(gl_gradientPanel_2.createParallelGroup(Alignment.TRAILING)
								.addComponent(lblNewLabel_5_1_1_1, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
								.addComponent(gradientPanel_3_1_1_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
							.addGap(18)
							.addGroup(gl_gradientPanel_2.createParallelGroup(Alignment.LEADING)
								.addComponent(gradientPanel_3_1_1_1_1, GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
								.addComponent(lblNewLabel_5_1_1_1_1, GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE))
							.addGap(28)
							.addGroup(gl_gradientPanel_2.createParallelGroup(Alignment.TRAILING)
								.addComponent(gradientPanel_3_1_1_1_1_1, 0, 0, Short.MAX_VALUE)
								.addComponent(lblNewLabel_5_1_1_1_1_1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 54, Short.MAX_VALUE)))
		...
		gl_gradientPanel_3.setHorizontalGroup(
			gl_gradientPanel_3.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_gradientPanel_3.createSequentialGroup()
					.addContainerGap()
					.addComponent(money_receiver, GroupLayout.DEFAULT_SIZE, 427, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_gradientPanel_3.setVerticalGroup(
			gl_gradientPanel_3.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_gradientPanel_3.createSequentialGroup()
					.addContainerGap()
					.addComponent(money_receiver, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		);
		...
		btnAccept.addActionListener(new insert_transaction_controller(this, this.c));
		btnNewButton.addActionListener(new transfer_controller(this.c));
    }
